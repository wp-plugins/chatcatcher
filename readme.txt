...
- Added support for the Chat Catcher Intense Debate Plugin.
...
1. If using the Intense Debate plugin, `Custom Trackback` must be selected.  A Chat Catcher plugin is available for Intense Debate.
